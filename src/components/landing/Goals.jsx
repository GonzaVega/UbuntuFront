...
export default function Goals(){
    ...
    return(
        ...
        >
            <Typography variant="h2" component="h2" align="center" gutterBottom sx={{ // Estilos específicos para el título "Objetivos de Ubuntu"
                fontFamily: 'Lato',
                fontSize: '22px',
                fontWeight: 700,
                lineHeight: '25px',
            ...
            <List sx={{ ...theme.typography.body1, color: theme.palette.text.primary, pt:0, listStyleType: 'disc', pl: 3 }}>
