...
import ExampleForm from '@/components/layouts/FormExample';
import CardExample from '@/components/layouts/CardExample';
          ...
          <Grid item xs={12} md={3}>
            ...
            >
              <Typography sx={(theme) => theme.typography.parrafos}>
                Este es texto parrafo personalizado. Este es texto parrafo personalizado. Este es
                texto parrafo personalizado. Este es texto parrafo personalizado. Lorem
              </Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} md={3}>
